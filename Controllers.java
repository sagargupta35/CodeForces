    ...
    public static void main(String[] args) throws java.lang.Exception {
        ...
        while (q-- > 0){
            ...
            if(a == b){
                ...
                long diff = Math.abs(p-m);
                long lcm =  lcm(a, b);
                long max1 = Math.max(lcm/a, lcm/b);
                long min1 = Math.min(lcm/a, lcm/b);
                long d2 = max1-min1;
                if(diff%d2 == 0){
                    long div = diff/d2;
                    long max2 = Math.max(p, m);
                    long min2 = Math.min(p, m);
                    if(div*max1 <= max2 && div*min1 <= min2){
                        System.out.println("YES");
                    } else System.out.println("NO");
                } else System.out.println("NO");
            }
