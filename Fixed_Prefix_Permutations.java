...
public class Main {
    ...
    static class Node{
        ...
        void addLink(int [] perm){
            if(links[perm[0]] == null){
                links[perm[0]] = new Node(m);
            }
            Node cur = links[perm[0]];
            for (int i = 1; i < m; i++) {
                if(cur.links[perm[i]] == null){
                    cur.links[perm[i]] = new Node(m);
                }
                cur = cur.links[perm[i]];
            }
        }
