...
public class CodeChef3 {
        ...
        while (t-- > 0){
            ...
            while (m-- > 0){
                ...
                if(s.charAt(l) == '0' && s.charAt(r) == '1'){
                    int ze = lowerBound(z, r);
                    int os = upperBound(o, l, n);
                    if(ze == os-1){
                        flag = true;
                    } else{
                        solve(set, l, r, z, o);
    ...
    static void solve(Set<String> set, int l, int r, List<Integer> z, List<Integer> o){
        int n = z.size() + o.size();
        l = lowerBound(o, l-1)+1;
        r = upperBound(z, r+1, n) - 1;
        set.add(l + " " + r);
    }
    ...
    static int upperBound(List<Integer> list, int target, int n){
        int lo = 0, hi = list.size()-1;
        int ans = n;
        while (lo <= hi){
            int mid = lo + (hi - lo)/2;
