...
public class CodeChef3 {
    ...
    public static void main(String[] args) throws java.lang.Exception {
        ...
        while (t-- > 0){
            ...
            long cur = Long.parseLong("1".repeat(s.length()));
            if(canSum(Long.parseLong(s), cur)) System.out.println("YES");
            else System.out.println("NO");
        }
        out.close();
    }

    static boolean canSum(long num, long cur){
