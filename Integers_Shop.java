...
public class CodeChef3 {
    ...
    public static void main(String[] args) throws java.lang.Exception {
        ...
        while (t-- > 0) {
            int n = in.nextInt();
            long a1 = Integer.MAX_VALUE, a2 = a1, b1 = a1, b2 = a1;
            ...
            while (n-- > 0){
                ...
                if(l < left){
                    ...
                    if(r > right){
                        a2 = c;
                    } else if(r == right) a2 = Math.min(a2, c);
                }
                if(r > right){
                    b1 = c;
                    right = r;
                    ...
                    if(l < left){
                        b2 = c;
                    } else if(l == left) b2 = Math.min(b2, c);
                }
                if(a1 == a2){
                    if(b1 == b2){
                    ...
                    System.out.println(Math.min(Math.min(a2, b2), a1+b1));
                }
            }
        }
        out.close();
