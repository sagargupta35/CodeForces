...
import java.util.*;
 ...
 public class CodeChef3 {
    ...
    public static void main(String[] args) throws java.lang.Exception {
        ...
        int q = in.nextInt();
        NavigableSet<Integer> [] arr = new TreeSet [26];
        Arrays.setAll(arr, i -> new TreeSet<>());
        ...
        while (q-- > 0){
            ...
            if(t == 1){
                ...
                arr[s.charAt(pos)-'a'].remove(pos);
                s.setCharAt(pos, query[2].charAt(0));
                arr[s.charAt(pos)-'a'].add(pos);
            } else{
                int l = Integer.parseInt(query[1])-1;
                int r = Integer.parseInt(query[2])-1;
                int cnt = 0;
                for (int i = 0; i < 26; i++) {
                    Integer lo = arr[i].floor(r);
                    if(lo != null && lo >= l) cnt++;
                }
