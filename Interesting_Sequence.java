    ...
    public static void main(String[] args) throws java.lang.Exception {
        ...
        while (t-- > 0){
            ...
            if((x&1) == 1){
                ...
                if(x == 0){
                    System.out.println(Long.valueOf("1"+"0".repeat(Long.toBinaryString(n).length()), 2));
                } else{
                    String s1 = Long.toBinaryString(n);
                    String s2 = Long.toBinaryString(x);
                    if(s1.length() != s2.length()){
                        ...
                        if(st == -1){
                        ...
                        else if(st == 0) System.out.println(n);
                        else{
                            ...
                            if(st == -1){
                                ...
                                String s = s1.substring(0, st-1) + "1" + "0".repeat(s1.length()-st);
