...
import java.io.*;
 ...
 public class CodeChef3 {
    ...
    static StringBuilder base9(long k){
    ...
    static void add1(StringBuilder sbr){
        boolean carry = false;
        int i = sbr.length()-1;
        while (i >= 0){
            if(carry){
                if(sbr.charAt(i) >= 8){
                    ...
                    sbr.setCharAt(i, (char) (sbr.charAt(i)+2));
                    carry = false;
                }
            } else{
                if(sbr.charAt(i) == '9'){
    ...
    static void fill(int [] arr, int st, int prev){
